...
|-----------|---------|----------|
| Direct | Say what you mean, skip the filler | Vague, overly formal |
| Confident | We know our craft (10+ years) | Arrogant, dismissive |
...
- Confident, benefit-first, no fluff
- Lead with what the reader gets, not what we do
- Short sentences. Active voice.

**Good:**
> We build tools. You build your business. Simple.

**Bad:**
> We provide comprehensive solutions to empower your business growth and digital transformation journey.
...
**Good:**
> 作ったものは、一緒に育てていく。ラビーはそういうチームです。

**Bad:**
> 弊社は包括的なソリューションを提供し、お客様のビジネスの成長をサポートいたします。
...
**Bad:**
> Chimr is a comprehensive productivity suite featuring calendar integration, task management, and meeting coordination capabilities.

### SNS / Social Media

- Conversational, community-oriented
- Share behind-the-scenes, real development stories
- OK to be playful, but not cute or forced
...
- Precise, developer-friendly
- Code examples over prose
- No marketing language in docs
- Assume the reader is competent

**Good:**
> Pass `--format json` to get machine-readable output. Defaults to plain text.
...
> エンジニアが直接話を聞いて、直接作る。ラビーのやり方はシンプルです。

> 横浜線沿線のお客様と、近い距離で仕事をしています。Slackで気軽に相談してください。

> もっと自由に、もっと楽しく。テクノロジーの力で、働き方を変えていく。

### English

> We sit close to our clients. When you have a question, you talk to the engineer who wrote the code.
